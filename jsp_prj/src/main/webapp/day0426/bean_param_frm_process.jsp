...
<li>점심식사 : <jsp:getProperty property="lunch" name="memberVO"/>(${param.password})</li>
<li>tel : <jsp:getProperty property="tel" name="memberVO"/>(${param.tel})</li>
<li>cell : <jsp:getProperty property="cell" name="memberVO"/>(${param.cell})</li>
<li>issms : <jsp:getProperty property="issms" name="memberVO"/>(${empty param.issms ? "수신안함" : "수신함"})</li>
<li>lunch : (${paramValues.lunch[0]})</li>
<br/>
<%
