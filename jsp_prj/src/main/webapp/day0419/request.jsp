...
<div>
	...
	[<a href="http://192.168.10.210//day0419/request.jsp?name=정명호&age=25&age=24">다른서버요청</a>|
	<a href="http://localhost//day0419/request.jsp?name=정명호&age=25&age=24">localhost요청</a>]

	<form method="post" action="request.jsp">
		<input type="hidden" name="name" value="윤웅찬">
		<input type="hidden" name="age" value="나이">
		<input type="hidden" name="age" value="윤웅찬">
		<input type="submit" name="name" value="윤웅찬">
	</form>
</div>
</body>
