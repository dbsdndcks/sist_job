...
입력하신 제조국[<strong><c:out value="${param.country}"/></strong>]으로 검색결과<br>
<c:catch var="e">
<%
...
<tr>
<td><img src="http://192.168.10.231/mybatis_prj/day0529/car_img/${cd.car_img }" style="width: 100px ;height: 100px"/></td>
...
<td><c:out value="${linkStart }"/><c:out value="${cd.maker}"/><c:out value="${linkEnd }"/></td>
