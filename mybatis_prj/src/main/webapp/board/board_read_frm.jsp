...
<script type="text/javascript">
	$(function(){
		$("#btnList").click(function(){
			//history.back();
			location.href="http://192.168.10.210/jsp_prj/board/board_list.jsp?currentPage=${ param.currentPage}";
		});//click
...
<%
	...
	%>
	<script type="text/javascript">
	location.href="http://192.168.10.231/my_batis/error/err_500.html";
	</script>
	<%
	}//end catch
%>
...
<div id="reply_wrap">
	...
	내용<input type="text" name="rContent" id="rContent" style="width: 400px"/>  
