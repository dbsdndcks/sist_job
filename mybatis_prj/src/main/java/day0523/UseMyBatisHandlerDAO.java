...
public class UseMyBatisHandlerDAO {
	...
	public static void main(String[] args)
		...
		/*
		 * System.out.println(de.encryption("ywcsuwon@naver.com"));
		 * System.out.println(de.encryption("dndsu123@"));
		 * 
		 * try { EmailVO emVO = new EmailVO(1, "ywcsuwon@naver.com", "메일테스트", "잘사냐?");
