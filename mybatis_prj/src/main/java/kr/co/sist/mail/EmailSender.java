...
public class EmailSender {
    ...
    public  void mainSend(EmailVO eVO) throws NoSuchAlgorithmException, GeneralSecurityException, IOException {
    	
    	Properties prop = new Properties();
    	System.out.println(System.getProperty("user.dir"));
    	try {
    		FileInputStream fis = new FileInputStream(System.getProperty("user.dir")+"/src/main/java/properties/email.properties");
    		prop.load(fis);
        ...
        props.put("mail.smtp.host", "smtp.naver.com"); // SMTP서버의 호스트 명을 설정
        props.put("mail.smtp.port", "587"); //SMTP포트는 587

        // 세션 생성 : 이메일 메시지를 구성하고 전송하는 데 사용
        //Authenticator : SMTOP 서버 인증에 필요한 사용자명과 비번을 전달하는 클래스
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException, GeneralSecurityException, IOException {
		...
		EmailVO eVO = new EmailVO(0, "ywcsuwon@naver.com", "ddd", "ddd");
		e.mainSend(eVO);
