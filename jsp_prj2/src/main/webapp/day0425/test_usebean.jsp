...
<!-- 객체성성, 값 할당을 action tag로 수행 -->
<jsp:useBean id="tVO" class="day0425.TestVO" scope="page"/>
<!-- setter method 호출 -->
<jsp:setProperty property="deptno" name="tVO" value="20"/>
<jsp:setProperty property="dname" name="tVO" value="웅찬"/>
<jsp:setProperty property="loc" name="tVO" value="서울"/>
...
<%
//useBeam의 id는 객체명이므로 scriptlet, expression에서 id를 사용할 수 있다
data.setDeptno(10);
data.setDname("경기");
data.setLoc("서울");
%>
<a href="use_bean2.jsp">이동</a>
</div>
</body>
</html>