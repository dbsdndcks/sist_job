...
<script type="text/javascript">
	window.onload=function(){
		document.getElementById("email").addEventListener("keydown",keychk);
    ...
    <link href="https://getbootstrap.kr/docs/5.3/examples/sign-in/sign-in.css" rel="stylesheet">
  </head>
...
<main class="form-signin w-100 m-auto">
  <form name="frm" action="login_process.jsp" method="post">
    <img class="mb-4" src="../common/images/img.jpg" alt="" width="72" height="57">
    ...
    <div class="form-check text-start my-3" id="resultDiv">
      <input class="form-check-input" type="checkbox" value="remember-me" id="flexCheckDefault">
      <label class="form-check-label" for="flexCheckDefault">
      </label>
    </div>
    <input type="button" class="btn btn-primary w-100 py-2" value="시아시현"/>
    <p class="mt-5 mb-3 text-body-secondary">&copy; 포미닛의 멤버 박시현</p>
  </form>
</main>
