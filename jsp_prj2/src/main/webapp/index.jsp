...
<!--jQuery CDN ��-->
<style type = "text/css">
	#wrap{width: 1462px; height: 749px; margin: 0px auto; position: relative;
	background: #ffffff url('http://192.168.10.231/jsp_prj/common/images/sist.png')	
	}
...
<div id="wrap">
	<div id="memberDiv">
	<a href="http://192.168.10.231/jsp_prj/member/${url}" class="memberLink">회원가입</a>
	<a href="#void" class="memberLink">로그인</a>
	<a href="http://192.168.10.231/jsp_prj/member/member_join_frm.jsp" class="memberLink">회원가입</a>
	</div>
</div>
</body>
</html>