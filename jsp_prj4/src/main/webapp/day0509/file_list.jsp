...
<link rel="icon" href="http://192.168.10.216//common/favicon.ico"/>
<!--bootstrap 시작-->
...
<div>
<%
	File uploadDir=new File("C:/E/dev/workspace//src/main/webapp/upload");
	...
	if(fileList != null){
	  ...
	  for(int i=0; i<fileList.length; i++){
	    ...
	    <tr>
	    	...
	    	<td>
	    	<% if(flag){ %>
	    	<img src="../upload/<%= tempFile.getName() %>" style= "width:60px; height:60px;"/> 
	    	<% } %>
	    	<a href="download.jsp?fileName=<%= tempFile.getName() %>"><%= tempFile.getName() %></a></td>
	  ...
	  %>
	  <tr><td colspan="3">업로드된 파일이 없습니다.<a href="../day0508/file_frm.jsp">업로드</a></td></tr>
	  <%
	}
%>
</table>
